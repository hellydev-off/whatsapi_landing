  ...
  <div class="about-container">
    <div class="about-card">
      ...
      <section class="mission-section">
        ...
        >
          С 2019 года мы занимаемся интеграцией мессенджеров и соцсетей с CRM,
          которые помогают взаимодействовать с пользователями в WhatsApp,
          Telegram, MAX и в других мессенджерах.
        </p>
        ...
        >
          Мы представляем наши услуги для представителей малого, среднего и
          крупного бизнеса, агентств и турфирм — размер нашей клиентской базы
          составляет <strong>3 тысячи человек</strong>.
        </p>
        ...
        >
          Уже <strong>7 лет</strong> мы работаем и облегчаем коммуникацию с
          клиентами.
        </p>
      </section>
      ...
      <p class="legal-info">
        WhatsApi 2019–2026 &nbsp;|&nbsp; ИП Красников Евгений Михайлович
        &nbsp;|&nbsp; ИНН 526019535896 &nbsp;|&nbsp; ОГРНИП 326527500001626
      </p>
    </div>
  </div>
</template>
