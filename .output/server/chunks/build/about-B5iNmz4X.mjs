...
const _imports_1 = publicAssetsURL("/qr-vk.png");
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0;
  const _directive_motion = resolveDirective("motion");
  let _temp0;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "about-container" }, _attrs))} data-v-2135a1db><div class="about-card" data-v-2135a1db><header${ssrRenderAttrs(mergeProps({
    class: "about-header",
    initial: { opacity: 0, y: -40 },
    visibleOnce: { opacity: 1, y: 0, transition: { duration: 800 } }
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-2135a1db><h1 class="page-title" data-v-2135a1db> О компании Ватс<span class="green-title" data-v-2135a1db>Апи</span></h1><p class="subtitle" data-v-2135a1db> Официальный интегратор мессенджеров для <img${ssrRenderAttr("src", _imports_0)} alt="UON" data-v-2135a1db></p></header><hr${ssrRenderAttrs(_temp0 = mergeProps({
    class: "divider",
  ...
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-2135a1db>${"textContent" in _temp0 ? ssrInterpolate(_temp0.textContent) : _temp0.innerHTML ?? ""}<section class="mission-section" data-v-2135a1db><p${ssrRenderAttrs(mergeProps({
  ...
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-2135a1db> Мы помогаем туристическим агентствам объединять все каналы связи в единую CRM-систему. </p><p${ssrRenderAttrs(mergeProps({
  ...
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-2135a1db><strong data-v-2135a1db>Наша задача</strong> — чтобы вы не теряли сообщения клиентов и отвечали на них быстрее. </p></section><div class="features-grid" data-v-2135a1db><div${ssrRenderAttrs(mergeProps({
    class: "feature-item",
  ...
  }, ssrGetDirectiveProps(_ctx, _directive_motion)))} data-v-2135a1db><div class="contacts-card-content" data-v-2135a1db><div class="contacts-text" data-v-2135a1db><h2 class="section-title" data-v-2135a1db>Свяжитесь с нами</h2><p class="contacts-desc" data-v-2135a1db> Есть вопросы по интеграции или работе сервиса? Наша команда поддержки всегда на связи. </p><div class="contacts-methods" data-v-2135a1db>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="contact-icon email-bg" data-v-2135a1db${_scopeId}>✉</div><div class="contact-info" data-v-2135a1db${_scopeId}><span class="label" data-v-2135a1db${_scopeId}>Напишите нам</span><span class="value" data-v-2135a1db${_scopeId}>hello@whatsapi.ru</span></div>`);
      } else {
        return [
          createVNode("div", { class: "contact-icon email-bg" }, "✉"),
          createVNode("div", { class: "contact-info" }, [
            createVNode("span", { class: "label" }, "Напишите нам"),
            createVNode("span", { class: "value" }, "hello@whatsapi.ru")
          ])
        ];
      }
    }),
  ...
  _push(`</div></div><div class="qr-container" data-v-2135a1db><div class="qr-box" data-v-2135a1db><img${ssrRenderAttr("src", _imports_1)} alt="QR Код ВК" class="qr-code-img" data-v-2135a1db><div class="qr-caption" data-v-2135a1db><img src="https://upload.wikimedia.org/wikipedia/commons/f/f3/VK_Compact_Logo_%282021-present%29.svg" alt="VK" width="18" data-v-2135a1db><span data-v-2135a1db>Группа ВКонтакте</span></div><a href="https://vk.ru/whatsapi" target="_blank" class="qr-vk-btn" data-v-2135a1db> Перейти в группу ВК </a></div></div></div></section></div></div>`);
}
...
const About = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-2135a1db"]]), { __name: "SectionsAbout" });
const _sfc_main = {
  __name: "about",
...
//# sourceMappingURL=about-B5iNmz4X.mjs.map
