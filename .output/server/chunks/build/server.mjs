import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { hasInjectionContext, getCurrentInstance, defineComponent, useSlots, h, Fragment, defineAsyncComponent, inject, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, createApp, reactive, toRaw, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, effectScope, watch, mergeProps, withCtx, getCurrentScope, toRef, nextTick, toValue, onScopeDispose, isReadonly, useSSRContext, isRef, isShallow, isReactive } from 'vue';
...
import { ssrRenderSuspense, ssrRenderComponent, ssrRenderVNode, ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import 'node:http';
import 'node:https';
import 'node:events';
import 'node:buffer';
...
const _routes = [
  {
    name: "api",
    path: "/api",
    component: () => import('./api-DnFk0q7s.mjs')
  },
  {
    name: "docs",
    path: "/docs",
    component: () => import('./docs-HUbeZF5O.mjs')
  },
  {
    name: "about",
    path: "/about",
    component: () => import('./about-Ga7AjO_k.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-kNWv8k4-.mjs')
  },
  {
    name: "signup",
    path: "/signup",
  ...
  },
  {
    name: "tariffs",
    path: "/tariffs",
    component: () => import('./tariffs-CyFLezmS.mjs')
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import('./contacts-CT0rmi2X.mjs')
  },
  {
    name: "documents",
    path: "/documents",
    component: () => import('./documents-yJsRDY7F.mjs')
  },
  {
    name: "integrations",
    path: "/integrations",
    component: () => import('./integrations--69ieWrz.mjs')
  },
  {
    name: "integration-uon",
    path: "/integration/uon",
    component: () => import('./uon-ClfL000S.mjs')
  }
];
...
const layouts = {
  frame: defineAsyncComponent(() => import('./Frame-Cgxcj7h0.mjs').then((m) => m.default || m))
};
...
const _imports_0 = publicAssetsURL("/form/feedback.svg");
...
const _sfc_main$3 = {
  __name: "SectionsFeedBackFormModal",
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (__props.isOpen) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "modal-overlay" }, _attrs))} data-v-2ca001f8><div class="modal-container" data-v-2ca001f8><button class="close-btn" aria-label="Закрыть" data-v-2ca001f8> × </button><section class="feedback-wrapper" data-v-2ca001f8><header class="feedback-header" data-v-2ca001f8><h2 data-v-2ca001f8>Остались вопросы?</h2><p data-v-2ca001f8>Оставьте заявку и мы свяжемся с вами</p></header><div class="feedback-layout" data-v-2ca001f8><form class="feedback-form" data-v-2ca001f8>`);
        if (successMessage.value) {
          _push(`<div class="success-msg" data-v-2ca001f8>${ssrInterpolate(successMessage.value)}</div>`);
        } else {
          _push(`<!---->`);
        }
        if (errorMessage.value) {
          _push(`<div class="error-msg" data-v-2ca001f8>${ssrInterpolate(errorMessage.value)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<input type="text"${ssrRenderAttr("value", form.name)} placeholder="Ваше имя" class="input-field" required${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} data-v-2ca001f8><input type="tel"${ssrRenderAttr("value", form.phone)} placeholder="Номер телефона" class="input-field" required${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} data-v-2ca001f8><textarea placeholder="Ваш вопрос" class="textarea-field"${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} data-v-2ca001f8>${ssrInterpolate(form.question)}</textarea><button type="submit" class="submit-btn"${ssrIncludeBooleanAttr(loading.value) ? " disabled" : ""} data-v-2ca001f8>${ssrInterpolate(loading.value ? "Отправка..." : "Отправить")} <svg width="11" height="14" viewBox="0 0 11 14" fill="none" data-v-2ca001f8><path d="M2.28267e-06 11.9107V2.08929C-0.000591436 1.70155 0.114952 1.32158 0.333258 0.993356C0.551565 0.665135 0.863708 0.402083 1.23356 0.23465C1.67239 0.0386502 2.16062 -0.0368408 2.64261 0.0167792C3.1246 0.0703991 3.58098 0.250973 3.95972 0.537925L10.2509 5.44863C10.486 5.64135 10.6746 5.87961 10.8039 6.14728C10.9331 6.41494 11 6.70575 11 7C11 7.29425 10.9331 7.58506 10.8039 7.85272C10.6746 8.12039 10.486 8.35865 10.2509 8.55136L3.95972 13.4621C3.58098 13.749 3.1246 13.9296 2.64261 13.9832C2.16062 14.0368 1.67239 13.9613 1.23356 13.7653C0.863708 13.5979 0.551565 13.3349 0.333258 13.0066C0.114952 12.6784 -0.000591436 12.2984 2.28267e-06 11.9107Z" fill="white" data-v-2ca001f8></path></svg></button></form><div class="feedback-image" data-v-2ca001f8><img${ssrRenderAttr("src", _imports_0)} alt="Иллюстрация" data-v-2ca001f8></div></div></section></div></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main$3.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/feedBackForm/Modal.vue");
  return _sfc_setup$3 ? _sfc_setup$3(props, ctx) : void 0;
};
const Modal = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-2ca001f8"]]);
...
function useModal() {
  ...
  return {
    isOpen,
    // Теперь это одна и та же переменная для всех
    open,
    close
  };
}
const _sfc_main$2 = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const { isOpen: isOpen2, close } = useModal();
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLayout, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(Modal, {
              onClose: unref(close),
              isOpen: unref(isOpen2)
...
export { _export_sfc as _, useNuxtApp as a, useRuntimeConfig as b, nuxtLinkDefaults as c, _imports_0 as d, entry_default as default, encodeRoutePath as e, navigateTo as n, resolveRouteObject as r, useRouter as u };
