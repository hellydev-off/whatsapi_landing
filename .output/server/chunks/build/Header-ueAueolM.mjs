...
const integrationsSection = { "messengerText": "Общайтесь там, где удобно вашим клиентам", "messengers": [{ "title": "Telegram", "icon": "/integrationsSection/telegram_icon.svg" }, { "title": "WhatsApp", "icon": "/integrationsSection/whatsapp_icon.svg" }, { "title": "Max", "icon": "/integrationsSection/max_icon.svg" }, { "title": "Instagram*", "icon": "/integrationsSection/instagram_logo.svg", "isComingSoon": true }, { "title": "Avito", "icon": "/integrationsSection/avito_logo.svg", "isComingSoon": true }, { "title": "Telegram-bot", "icon": "/integrationsSection/tgbot_logo.svg", "isComingSoon": true }, { "title": "Вконтакте", "icon": "/integrationsSection/vk_icon.svg", "isNew": true }, { "title": "SMS", "icon": "/integrationsSection/sms.svg", "isNew": true }, { "title": "Email", "icon": "/integrationsSection/email.svg", "isNew": true }], "crmText": "Свяжите сервис с любой из популярных CRM-платформ", "crm": [{ "icon": "/integrationsSection/amo_icon.svg", "isComingSoon": true }, { "icon": "/integrationsSection/bitrix_icon.svg", "isComingSoon": true }, { "icon": "/integrationsSection/uon_icon.svg" }] };
...
//# sourceMappingURL=Header-ueAueolM.mjs.map
