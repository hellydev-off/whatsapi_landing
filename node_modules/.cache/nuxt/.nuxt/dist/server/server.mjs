...
import { $fetch } from "/Users/helly/Documents/whatsapi/whatsapi_landing/node_modules/ofetch/dist/node.mjs";
import { baseURL, publicAssetsURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/helly/Documents/whatsapi/whatsapi_landing/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/helly/Documents/whatsapi/whatsapi_landing/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/helly/Documents/whatsapi/whatsapi_landing/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import defu$1, { defu } from "/Users/helly/Documents/whatsapi/whatsapi_landing/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/Users/helly/Documents/whatsapi/whatsapi_landing/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "api",
    path: "/api",
    component: () => import("./_nuxt/api-VFRGAXDA.js")
  },
  {
    name: "docs",
    path: "/docs",
    component: () => import("./_nuxt/docs-CjmQTUik.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-oPIYqDsO.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Dc5zvMOt.js")
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import("./_nuxt/signup-DmX4iRDb.js")
  },
  {
    name: "tariffs",
    path: "/tariffs",
    component: () => import("./_nuxt/tariffs-BY9PBGQm.js")
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import("./_nuxt/contacts-uzkSbDoh.js")
  },
  {
    name: "documents",
    path: "/documents",
    component: () => import("./_nuxt/documents-Di_oWmup.js")
  },
  {
    name: "integrations",
    path: "/integrations",
    component: () => import("./_nuxt/integrations-CTd87q8G.js")
  },
  {
    name: "integration-uon",
    path: "/integration/uon",
    component: () => import("./_nuxt/uon-CcDubLa9.js")
  }
];
...
const layouts = {
  frame: defineAsyncComponent(() => import("./_nuxt/Frame-CO3k-wpV.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-B91iVqsH.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CZqye8FT.js"));
