import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, onScopeDispose, watch, computed, toValue, unref, defineComponent, useSlots, h, Fragment, ref, defineAsyncComponent, provide, Suspense, nextTick, mergeProps, useSSRContext, withCtx, createVNode, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "/Users/helly/Documents/code/whatsapi/whatsapi_landing/node_modules/ofetch/dist/node.mjs";
import { baseURL, publicAssetsURL } from "#internal/nuxt/paths";
import { createHooks } from "/Users/helly/Documents/code/whatsapi/whatsapi_landing/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/Users/helly/Documents/code/whatsapi/whatsapi_landing/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "/Users/helly/Documents/code/whatsapi/whatsapi_landing/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import defu$1, { defu } from "/Users/helly/Documents/code/whatsapi/whatsapi_landing/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "/Users/helly/Documents/code/whatsapi/whatsapi_landing/node_modules/ufo/dist/index.mjs";
...
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrIncludeBooleanAttr, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
if (!globalThis.$fetch) {
...
const _routes = [
  {
    name: "api",
    path: "/api",
    component: () => import("./_nuxt/api-BZiPpVo4.js")
  },
  {
    name: "docs",
    path: "/docs",
    component: () => import("./_nuxt/docs-CiniiTy0.js")
  },
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-CwsXOMQY.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-CWtPK-mF.js")
  },
  {
    name: "signup",
    path: "/signup",
    component: () => import("./_nuxt/signup-DF51_ys0.js")
  },
  {
    name: "tariffs",
    path: "/tariffs",
    component: () => import("./_nuxt/tariffs-CfaZpo2S.js")
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import("./_nuxt/contacts-D6rru8uR.js")
  },
  {
    name: "documents",
    path: "/documents",
    component: () => import("./_nuxt/documents-WJWPN8dl.js")
  },
  {
    name: "integrations",
    path: "/integrations",
    component: () => import("./_nuxt/integrations-BwvwN1Hv.js")
  },
  {
    name: "integration-uon",
    path: "/integration/uon",
    component: () => import("./_nuxt/uon-D57nglMd.js")
  }
];
...
const layouts = {
  frame: defineAsyncComponent(() => import("./_nuxt/Frame-BvmEWhWu.js").then((m) => m.default || m))
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DSYO7Vgl.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-ca1jgQex.js"));
